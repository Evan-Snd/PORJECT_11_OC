...
def test_purchasePlaces_required_places_is_equal_zero(
    test_client, points_text, db_data
):
...
def test_purchasePlaces_required_places_is_upper_than_available(
    test_client, points_text, db_data
):
...
def test_purchasePlaces_required_places_is_upper_than_twelve(
    test_client, points_text, db_data
):
